...
describe Books::AssetsController do
  ...
  it {should route(:get,'books/1/assets/get/thumb/20/filename.gif').to(
                 :controller => "books/assets", :action => :get, :book_id => 1, :style => "thumb", :asset_id => 20, :filename => "filename", :extension => "gif" )}
